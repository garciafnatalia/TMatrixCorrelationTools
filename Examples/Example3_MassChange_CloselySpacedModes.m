...
T_Mass_Matrix = T_Mass(B,A,'plot') 
%Also use: T_Mass_Matrix = T_Mass(B,A) 
...
%    discrepancies.
%  - Local rotations of closely spaced modes lead to significantly low MAC  
%    values. ROTMAC diagonal values are nearly equal to 1, since in the   
%    case of mass discrepancies with repeated modes, shear effects do not 
%    occur.
